...
export const fmtNum  = (v: number | null | undefined) => fNum.format(Number(v ?? 0));
export const fmt2    = (v: number | null | undefined) => fNum2.format(Number(v ?? 0));
export const fmtCOP  = (v: number | null | undefined) => fCOP.format(Number(v ?? 0));
